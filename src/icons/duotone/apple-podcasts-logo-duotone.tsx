...
const Icon = (props: IconProps) => {
  ...
  return (
    ...
    >
      ...
      <_Circle cx="128" cy="120" r="24" opacity="0.2" fill={`${color}`} />
      <_Path
      ...
      />
      <_Path
        d="M74.92,208a96,96,0,1,1,106.16,0"
        fill="none"
        stroke={`${color}`}
        strokeLinecap="round"
        strokeLinejoin="round"
...
export const ApplePodcastsLogoDuotone = memo<IconProps>(themed(Icon))
