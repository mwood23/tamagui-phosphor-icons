...
const Icon = (props: IconProps) => {
  ...
  return (
    ...
    >
      ...
      <_Path
        d="M128,24a7.84,7.84,0,0,0-7.34,4.9L97.43,84.26a8,8,0,0,1-6.67,4.88L31.3,94.28a8,8,0,0,0-4.54,14.07L71.87,147.7a8.08,8.08,0,0,1,2.54,7.89L60.89,214.13a8,8,0,0,0,11.89,8.69l51.1-31a7.93,7.93,0,0,1,4.12-1.16Z"
        opacity="0.2"
      />
      <_Path
