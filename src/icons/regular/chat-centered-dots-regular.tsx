...
const Icon = (props: IconProps) => {
  ...
  return (
    <_Svg viewBox="0 0 256 256" {...otherProps} height={size} width={size}>
      ...
      <_Circle cx="80" cy="120" r="12" fill={`${color}`} />
      <_Circle cx="176" cy="120" r="12" fill={`${color}`} />
    </_Svg>
  )
}

Icon.displayName = 'ChatCenteredDotsRegular'

export const ChatCenteredDotsRegular = memo<IconProps>(themed(Icon))
