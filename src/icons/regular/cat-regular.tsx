  ...
  return (
    <_Svg viewBox="0 0 256 256" {...otherProps} height={size} width={size}>
      ...
      <_Line
        ...
        strokeWidth="16"
      />
      <_Circle cx="84" cy="140" r="12" fill={`${color}`} />
      <_Circle cx="172" cy="140" r="12" fill={`${color}`} />
      <_Line
        x1="128"
        y1="48"
        x2="128"
...
Icon.displayName = 'CatRegular'

export const CatRegular = memo<IconProps>(themed(Icon))
