...
const Icon = (props: IconProps) => {
  ...
  return (
    <_Svg viewBox="0 0 256 256" {...otherProps} height={size} width={size}>
      ...
      <_Path
        d="M160,40a78.61,78.61,0,0,1,56,56"
        fill="none"
        stroke={`${color}`}
        strokeLinecap="round"
      ...
      />
      <_Path
        d="M152,72c16.52,4.42,27.58,15.48,32,32"
        fill="none"
        stroke={`${color}`}
        strokeLinecap="round"
        strokeLinejoin="round"
...
Icon.displayName = 'PhoneCallRegular'

export const PhoneCallRegular = memo<IconProps>(themed(Icon))
