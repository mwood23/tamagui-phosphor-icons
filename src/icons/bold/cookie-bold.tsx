  ...
  return (
    <_Svg viewBox="0 0 256 256" {...otherProps} height={size} width={size}>
      ...
      <_Path
        ...
        strokeWidth="24"
      />
      <_Circle cx="156" cy="172" r="16" fill={`${color}`} />
      <_Circle cx="92" cy="164" r="16" fill={`${color}`} />
      <_Circle cx="84" cy="108" r="16" fill={`${color}`} />
      <_Circle cx="136" cy="124" r="16" fill={`${color}`} />
    </_Svg>
  )
}
...
export const CookieBold = memo<IconProps>(themed(Icon))
